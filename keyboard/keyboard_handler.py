...
class KeyboardHandler:
    ...
    def __init__(self, game_settings):
        ...
        self.tracked_keys = [
            pygame.K_p, pygame.K_n, pygame.K_m, pygame.K_i, pygame.K_h, 
            pygame.K_r, pygame.K_b, pygame.K_1, pygame.K_2
            ]
    ...
    def update(self):
        ...
        for key in self.tracked_keys:
            if self.keys[key] and not self.pressed_last[key]:
                ...
                if key == pygame.K_n and self.game_settings.enemy_boss_alive == False and self.game_settings.is_enemy_boss_level():
                    self.game_settings.state = GameState.NEXT_LEVEL
                    self.game_settings.game_level = self.game_settings.game_level + 1
                ...
                if key == pygame.K_2:
                    self.game_settings.player_action = EntitiesActions.CONSUME_FLOWER_ATTACK

...
class ImagesAssetsLoader:
    ...
    def __init__(self, screen):
        ...
        self.enemy_boss_heavan_frame_one_image = pygame.image.load("assets/enemies/heaven-boss.png")
        ...
        self.enemy_boss_underwater_frame_one_image = pygame.image.load("assets/enemies/shark-boos-left.png")
